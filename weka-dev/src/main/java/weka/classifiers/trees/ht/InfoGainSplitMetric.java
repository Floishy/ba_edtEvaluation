...
public class InfoGainSplitMetric extends SplitMetric implements Serializable {
  ...
  @Override
  public SplitMetricResult evaluateSplit(Map<String, WeightMass> preDist,
    ...
    if (fracCount < 2) {
    	return new SplitMetricResult(Double.NEGATIVE_INFINITY,0,0);
    }
    ...
    double infoGain= preEntropy - postEntropy;
    
    return new SplitMetricResult(infoGain, preEntropy, postEntropy);
