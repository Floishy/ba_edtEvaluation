...
private SplitMetricResult splitMetricResult;
  ...
  public SplitCandidate(Split splitTest,
      List<Map<String, WeightMass>> postSplitDists, double merit,SplitMetricResult splitMetricResult) {
    m_splitTest = splitTest;
    m_postSplitClassDistributions = postSplitDists;
    m_splitMerit = merit;
	this.splitMetricResult = splitMetricResult;
  }

  
  public SplitMetricResult getSplitMetricResult() {
	return splitMetricResult;
}
  
  public void setSplitMetricResult(SplitMetricResult splitMetricResult) {
	this.splitMetricResult = splitMetricResult;
}
  /**
