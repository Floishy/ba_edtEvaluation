...
public class C45ModelSelection extends ModelSelection {
  ...
  public final ClassifierSplitModel selectModel(Instances data) {
    ...
    try {
      ...
      //XXX YTE The sum of instances that have a class label
      ...
      for (i = 0; i < data.numAttributes(); i++) {
        ...
        if (i != (data).classIndex()) {
          ...
          //TODO YTE Why the differentiation if(m_allData !=null)
      ...
      //XXX YTE all all instances with unknown values for the best attribute
