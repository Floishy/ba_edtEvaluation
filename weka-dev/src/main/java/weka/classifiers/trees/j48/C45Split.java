...
import de.uni.due.paluno.se.edt.OntologyImprover;
...
public class C45Split extends ClassifierSplitModel {
  ...
  //private OntologyImprover ontologyImprover;
  ...
  public C45Split(int attIndex, int minNoObj, double sumOfWeights,
   ...
   // ontologyImprover = new OntologyImprover(attIndex, minNoObj, sumOfWeights, useMDLcorrection);
  ...
  public void buildClassifier(Instances trainInstances) throws Exception {
	...
	//  trainInstances = ontologyImprover.findBetterAttributes(trainInstances);
